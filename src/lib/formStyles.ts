...
export const greFormActionsClass =
  "gre-dashboard-form-actions flex flex-col gap-3 border-t border-slate-200/90 bg-white/95 p-4 backdrop-blur-sm sm:flex-row sm:flex-wrap sm:items-center sm:gap-3 sm:p-5";
